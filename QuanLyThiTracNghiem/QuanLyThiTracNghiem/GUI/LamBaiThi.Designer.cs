namespace QuanLyThiTracNghiem.QuanLyThiTracNghiem.GUI
{
    partial class LamBaiThi
    {
        ...
        private void InitializeComponent()
        {
            ...
            label_DemThoiGian.Location = new Point(94, 23);
            ...
            // label_MaSinhVien
            // 
            label_MaSinhVien.AutoSize = true;
            label_MaSinhVien.Font = new Font("Segoe UI", 24F, FontStyle.Bold, GraphicsUnit.Point, 0);
            label_MaSinhVien.Location = new Point(339, 23);
            label_MaSinhVien.Name = "label_MaSinhVien";
            label_MaSinhVien.Size = new Size(199, 45);
            label_MaSinhVien.TabIndex = 3;
            label_MaSinhVien.Text = "MaSinhVien";
            // 
            // button_Thoat
            // 
            button_Thoat.BackColor = Color.Coral;
            button_Thoat.Image = (Image)resources.GetObject("button_Thoat.Image");
            button_Thoat.Location = new Point(1832, 18);
            ...
            button_NopBai.Click += button_NopBai_Click;
            // 
            // flowLayoutPanel_CauHoi
            // 
            flowLayoutPanel_CauHoi.Dock = DockStyle.Fill;
            flowLayoutPanel_CauHoi.Location = new Point(0, 99);
            flowLayoutPanel_CauHoi.Name = "flowLayoutPanel_CauHoi";
            flowLayoutPanel_CauHoi.Size = new Size(1904, 860);
        ...
        private Label label_MaSinhVien;
