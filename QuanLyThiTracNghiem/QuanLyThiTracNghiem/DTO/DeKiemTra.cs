...
namespace QuanLyThiTracNghiem.QuanLyThiTracNghiem.DTO
{
    public class DeKiemTra
    {
        ...
        public DeKiemTra() { }
        public DeKiemTra (int maDe, string tenDe, DateTime thoiGianBatDau, DateTime thoiGianKetThuc, DateTime thoiGianCanhBao, int soCauDe, int soCauTrungBinh, int soCauKho, int trangThai)
        {
            this.maDe = maDe;
            this.tenDe = tenDe;
